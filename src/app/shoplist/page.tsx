...
const ShopList = () => {
  ...
  return (
    <div className="w-[1920px] h-auto bg-white relative">
      {/* Loading overlay */}
      {isLoading && (
        <div className="absolute top-0 left-0 w-[1920px] h-full bg-black opacity-70 flex justify-center items-center z-50">
